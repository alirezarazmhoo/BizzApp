...
namespace DataLayer.Migrations
{
    ...
    [Migration("20210621080122_UpdateBizinessBiographyLenght")]
    partial class UpdateBizinessBiographyLenght
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainClass.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 21, 12, 31, 21, 273, DateTimeKind.Local).AddTicks(8075));
            ...
            modelBuilder.Entity("DomainClass.BizAppUser", b =>
                {
                    ...
                    b.Property<string>("MyFavoritMovie")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("WhenImNotYelping")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WhyYouShouldReadMyReviews")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "942de341-b7a9-4fef-81ae-c21cbd2acd77",
                            CreateDate = new DateTime(2021, 6, 21, 12, 31, 21, 278, DateTimeKind.Local).AddTicks(800),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAMeCATfgMAabkiEjVXju83XWM1t5TTk1vYiauwEZZovKOvR3kys7GMrFPvEs46NBQ==",
                            PhoneNumberConfirmed = false,
                            PhotoChanged = false,
                            SecurityStamp = "a187142f-9166-4343-821a-57a2085b7b9d",
            ...
            modelBuilder.Entity("DomainClass.Businesses.BusinessFaq", b =>
                {
                    ...
                    b.ToTable("BusinessFaqs");
                });

            modelBuilder.Entity("DomainClass.Businesses.BusinessFaqAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("BusinessFaqId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");

                    b.Property<int>("HelpFullCount")
                        .HasColumnType("int");

                    b.Property<int>("NotHelpFullCount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusinessFaqId");

                    b.ToTable("BusinessFaqAnswers");
                });
            ...
            modelBuilder.Entity("DomainClass.Businesses.BusinessRecentlyViewed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DomainClass.Businesses.MessageToBusiness", b =>
                {
                    ...
                    b.ToTable("MessageToBusinesses");
                });

            modelBuilder.Entity("DomainClass.Businesses.UsersInCommunityVotes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("BusinessFaqAnswerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("VotesType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusinessFaqAnswerId");

                    b.ToTable("UsersInCommunityVotes");
                });
            ...
            modelBuilder.Entity("DomainClass.Review.UsersInReviewVotes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DomainClass.Businesses.BusinessFaqAnswer", b =>
                {
                    ...
                    b.HasOne("DomainClass.Businesses.BusinessFaq", "BusinessFaq")
                        .WithMany("BusinessFaqAnswers")
                        .HasForeignKey("BusinessFaqId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DomainClass.Businesses.UsersInCommunityVotes", b =>
                {
                    ...
                    b.HasOne("DomainClass.Businesses.BusinessFaqAnswer", "BusinessFaqAnswer")
                        .WithMany()
                        .HasForeignKey("BusinessFaqAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DomainClass.Notification", b =>
                {
                    b.HasOne("DomainClass.BizAppUser", "Creator")
                        .WithMany()
